...
```
  ...
  Aparentemente a parte nao sazonal e um MA(1) (dps de uma diferenca) e a parte sazonal MA 1 tbm com uma diferenca, entao seria um $SARIMA(0,1,1)\times(0,1,1)_{12}$
